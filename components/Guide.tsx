...
const ARTICLES = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Do not dictate punctuation. Saying “comma” and “full stop” out loud is a habit left over from older systems; Dictami places commas, full stops and question marks from the shape of the sentence, and capitalises the start of each one. If you say the words out loud, you will get the words, not the marks.",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Dictami keeps the recognition model loaded in memory on your Mac. When you release the key, the audio never travels anywhere — the model is already warm and the text is ready in a fraction of a second. The same design is why it works with no connection at all: on a plane, on a train, in a building with no signal, the behaviour does not change.",
    ],
  },
  {
    heading: "Setting it up",
    paragraphs: [
      "Dictami needs macOS 13 Ventura or later on an Apple Silicon Mac — an M1 or anything after it. Intel Macs are not supported: the recognition engine is built for Apple Silicon, and the speed the app is built around comes from that hardware.",
      "On first launch you pick a language and download its model — one button in Settings, and a few minutes on a normal connection. After that the app never needs the internet again. macOS will ask for permission to use the microphone, and for Accessibility access, which is what lets the finished text be typed into whichever app your cursor is in rather than only into Dictami's own window.",
          ...
          <Reveal>
            ...
            <div className="lg:sticky lg:top-28">
              ...
              <p className="mt-5 max-w-sm text-[15.5px] leading-relaxed text-muted">
                What it is worth using for, how to get a clean result, and what
